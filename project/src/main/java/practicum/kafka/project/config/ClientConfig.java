...
public class ClientConfig {
    ...
    @Value("${client.producer.username}")
    private String producerUser;
    @Value("${client.producer.password}")
    ...
    private Properties getShopProducerProperties() {
        ...
        props.put("sasl.jaas.config", String.format(commonProps.getJaasTemplate(), producerUser, producerPassword));
        props.put("ssl.truststore.location", commonProps.getCacertsLocation());
        props.put("ssl.truststore.password", commonProps.getCacertsPassword());
        return props;
    }
