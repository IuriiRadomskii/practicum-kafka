...
resource "yandex_mdb_kafka_cluster" "yuriyradomskiy-mirror" {
  folder_id = "b1gh5kt0tm2akrua7dai"
  name        = "kafka1241243-mirror"
...
resource "yandex_mdb_kafka_topic" "data-products-topic" {
  cluster_id         = yandex_mdb_kafka_cluster.yuriyradomskiy-mirror.id
...
resource "yandex_mdb_kafka_connector" "mirror-maker-connector" {
  cluster_id = yandex_mdb_kafka_cluster.yuriyradomskiy-mirror.id
  ...
  connector_config_mirrormaker {
    ...
    source_cluster {
      ...
      external_cluster {
        ...
        sasl_username     = "mirror-user"
        sasl_password     = "mirror-user-password"
